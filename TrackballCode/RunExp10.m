...
function RunExp10(flyNum,flyExpNum,flyCond)
...
data.expNum = 10;                     % Alex's experiment number
...
data.stim.bgstimTrain(data.stim.pipStarts(1):data.stim.pipEnds(end)) = 0;
data.stim.bgstimTrain = data.stim.bgstimTrain+data.stim.stimTrain;
